...
class EarlyStopping:
    ...
    def compare(self, score):
        for i in range(len(score)):
            # Performance improvement is considered when any index increases
...
def get_user_seqs(args):
    time_seq = []
    user_idxs = []
    time_lines = open(args.time_file).readlines()
    ...
    item_lines = open(args.data_file).readlines()
    user_seq = []
    item_set = set()
    ...
    return user_seq, time_seq, max_item, valid_rating_matrix, test_rating_matrix, not_aug_users
