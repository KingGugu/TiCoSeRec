...
Then divide the dataset by half the amount of interactions.
...
file_name_in = './Sports.csv'
file_name_first = 'Sports_first_inter.csv'
file_name_last = 'Sports_last_inter.csv'
